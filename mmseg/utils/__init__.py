...
from .class_names import (ade_classes, ade_palette, bdd100k_classes,
                          ...
                          vaihingen_palette, voc_classes, voc_palette, mastr1325_classes,
                          mastr1325_palette, aerialfluvial_classes, aerialfluvial_palette,
                          rosebud_classes, rosebud_palette, uvinland_classes, uvinland_palette)
# yapf: enable
...
__all__ = [
    ...
    'mastr1325_classes',
    'mastr1325_palette',
    'aerialfluvial_classes',
    'aerialfluvial_palette',
    'rosebud_classes',
    'rosebud_palette',
    'uvinland_classes',
    'uvinland_palette'
